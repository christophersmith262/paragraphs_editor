...
namespace Drupal\paragraphs_editor\Plugin\Filter;

use Drupal\Core\Entity\EntityTypeManagerInterface;
use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Drupal\filter\FilterProcessResult;
use Drupal\filter\Plugin\FilterBase;
use Drupal\paragraphs_editor\EditorFieldValue\EmbedCodeProcessorInterface;
 ...
 *
 * @Filter(
 *   id = "paragraphs_editor_embed_formatter",
 *   title = @Translation("Render embedded paragraphs"),
 *   description = @Translation("Converts paragraphs-editor embed codes to rendered entities"),
 *   type = Drupal\filter\Plugin\FilterInterface::TYPE_TRANSFORM_IRREVERSIBLE
 * )
 */
class ParagraphsEditorFilter extends FilterBase implements EmbedCodeVisitorInterface, ContainerFactoryPluginInterface {
  ...
  public function __construct(array $configuration, $plugin_id, $plugin_definition, EntityTypeManagerInterface $entity_type_manager, EmbedCodeProcessorInterface $embed_code_processor, $renderer) {
    ...
    $this->tokenName = 'paragraphs-editor-paragraph-embed-token';
  }
  ...
  static public function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $container->get('paragraphs_editor.field_value.embed_code_processor'),
